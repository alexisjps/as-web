...
sleep(1)
Client.create!(first_name: 'Sanofi', last_name: "LTD", email: 'contact@sanofi.fr', phone: '0145949394', compagny_address: '46 AV DE LA GRANDE ARMEE 75017 PARIS', compagny_siret: '395030844', user_id: User.find_by(email: "test@test.com"))
puts 'user created'